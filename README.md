...
{% hint style="info" %}
JJazzLab-X has a well-commented source code: don't hesitate to browse the [GitHub repository](https://github.com/jjazzboss/JJazzLab-X) or the [javadoc API](https://www.jjazzlab.com/javadoc/index.html).
{% endhint %}
